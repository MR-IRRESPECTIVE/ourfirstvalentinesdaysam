...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        romantic: "var(--shadow-soft)",
        "card-romantic": "var(--shadow-card)",
        "button-romantic": "var(--shadow-button)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "float-heart": {
          ...
          "50%": { transform: "translateY(-40px) rotate(-5deg) scale(1)", opacity: "0.7" },
          "75%": { transform: "translateY(-20px) rotate(3deg) scale(1.05)", opacity: "0.9" },
        },
        "rise-up": {
        ...
        "pulse-glow": {
          "0%, 100%": { filter: "drop-shadow(0 0 10px hsl(340 82% 65% / 0.3))" },
          "50%": { filter: "drop-shadow(0 0 25px hsl(340 82% 65% / 0.6))" },
        },
        "gentle-bounce": {
      ...
      animation: {
        ...
        "rise-up": "rise-up 8s linear infinite",
